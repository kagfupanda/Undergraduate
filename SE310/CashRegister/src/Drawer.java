...
public class Drawer {
    ...
    /*
        ...
        it contains
     */
    long drawerTotalInCents(){ return this.totalCentValue; }
    public long penny(){ return this.cp.pennies(); }
    long nickle(){ return this.cp.nickles(); }
    long dime(){ return this.cp.dimes(); }
    long quarter(){ return this.cp.quarters(); }
    public long one(){ return this.bp.ones(); }
    long five(){ return this.bp.fives(); }
    long ten(){ return this.bp.tens(); }
    long twenty(){ return this.bp.twenties(); }
    long fifty(){ return this.bp.fifties(); }
    long hundred(){ return this.bp.hundreds(); }
    CoinPack coinPack(){ return this.cp; }
    BillPack billPack(){ return this.bp; }
     ...
     */
    protected void depositChange(long penny, long nickle, long dime, long quarter){
     ...
     */
    void depositChange(CoinPack cp){
     ...
     */
    protected void depositBills(long one, long five, long ten, long twenty, long fifty, long hundred){
     ...
     */
    protected boolean removeChange(long penny, long nickle, long dime, long quarter){
     ...
     * @return false when the drawer has insufficient coins to complete the request, otherwise true
     */
    boolean removeChange(CoinPack cp){
     ...
     */
    protected boolean removeBills(long one, long five, long ten, long twenty,
     ...
     * @return false when the drawer has insufficient bills to complete the request, otherwise true
     */
    boolean removeBills(BillPack bp){
     ...
     */
    static long centValueFromCoins(long penny, long nickle, long dime, long quarter){
     ...
     * @return The total value in cents
     */
    static long centValueFromCoins(CoinPack cp){
     ...
     * @return The total value in cents
     */
    static long centValueFromBills(long one, long five, long ten, long twenty,
                                   long fifty, long hundred){
        long total_pennies = 0;
     ...
     * @return The total value in cents
     */
    static long centValueFromBills(BillPack bp){
